        ...
        <div className="space-y-6 p-6 pb-80">
          <div className="space-y-1.5">
            ...
            <select
              ...
              className="h-14 w-full rounded-2xl border-none bg-slate-100 px-4 text-base font-bold text-black outline-none focus:ring-2 focus:ring-[#4A148C]"
            >
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="h-14 w-full rounded-2xl border-none bg-slate-100 pl-12 pr-4 text-base font-bold text-black outline-none transition-all focus:ring-2 focus:ring-[#4A148C]"
              />
            </div>
          </div>
          ...
          <button
            onClick={closeSearch}
            className="mt-4 h-14 w-full rounded-2xl bg-[#4A148C] text-lg font-black text-[#4A148C] shadow-lg transition-all active:scale-95"
          >
        ...
        <div className="flex flex-col gap-3">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            <div className="min-w-0">
              <p className="text-lg font-black text-[#4A148C]">ประวัติการรับเข้าสินค้า</p>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-start justify-between gap-2">
                          <h3 className="break-words text-[19px] font-black leading-tight text-black transition-colors group-hover:text-[#4A148C]">
                            {row.supplierName}
                          </h3>
                          <button
                            onClick={(e) => {
                      ...
                      <ChevronRight className="hidden h-6 w-6 self-center text-[#76777d] transition group-hover:text-[#4A148C] sm:block" strokeWidth={3} />
                    </div>
                  </div>
                ))}
              </section>
        ...
        {hasMore && groups.length > 0 && (
          <div className="mt-12 pb-20 text-center">
            <button
              ...
              className="mx-auto flex items-center gap-2 font-bold text-[#4A148C] hover:underline disabled:opacity-50"
            >
      ...
      {isDetailLoading && (
        <div className="fixed inset-0 z-[400] flex items-center justify-center bg-white/60 backdrop-blur-[2px]">
          <div className="flex flex-col items-center">
            ...
            <p className="mt-4 animate-pulse text-[12px] font-black uppercase tracking-widest text-[#4A148C]">กำลังดึงข้อมูล...</p>
          </div>
        </div>
      )}
        ...
        >
          ...
          >
            ...
            <div className="relative aspect-[3/4] w-full">
              {isImageLoading && <Loader2 className="absolute inset-0 m-auto h-10 w-10 animate-spin text-[#4A148C]" />}
