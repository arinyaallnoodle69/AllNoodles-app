...
const mockProducts = [
  ["ANP001", "ผัดไท มหาชัย (ยาว) (แดง)", "กก.", 5, 50],
  ["ANP002", "จิ๊บญวนสด ช้างคู่", "กก.", 5, 50],
  ["ANP003", "วุ้นเส้น กิเลนใหญ่ 450กรัม", "กก.", 5, 49],
  ["ANP004", "ผัดไท พระอาทิตย์ (แดง)", "กก.", 5, 100],
  ["ANP005", "ผัดไท มิตรภาพ", "กก.", 5, 100],
  ["ANP006", "เส้นเล็ก สด", "กก.", 8, 38],
  ["ANP007", "เส้นหมี่ขาว สด", "กก.", 8, 42],
  ["ANP008", "บะหมี่เหลือง สด", "กก.", 6, 55],
  ["ANP009", "เส้นใหญ่ สด", "กก.", 10, 35],
  ["ANP010", "เกี๊ยวแผ่น", "ห่อ", 12, 28],
  ["ANP011", "เส้นจันท์แห้ง", "ห่อ", 10, 45],
  ["ANP012", "วุ้นเส้นเล็ก", "ห่อ", 10, 32],
  ["ANP013", "หมี่กรอบ", "ห่อ", 7, 68],
  ["ANP014", "บะหมี่ไข่", "กก.", 5, 60],
  ["ANP015", "เส้นเล็กแห้ง", "ห่อ", 10, 40],
  ["ANP016", "เส้นใหญ่แห้ง", "ห่อ", 9, 46],
  ["ANP017", "เส้นเล็ก รังนก", "กก.", 5, 50],
  ["ANP018", "ขนมจีนสด", "กก.", 12, 24],
  ["ANP019", "แผ่นเกี๊ยวทอด", "ห่อ", 6, 75],
  ["ANP020", "เส้นหมี่โคราช", "ห่อ", 8, 52],
  ["ANP021", "เส้นบะหมี่หยก", "กก.", 4, 70],
  ["ANP022", "ก๋วยจั๊บญวน", "กก.", 4, 65],
