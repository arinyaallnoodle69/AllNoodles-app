        ...
        <div className="space-y-5 px-6 py-6">
          ...
          <div>
            <label className="mb-1.5 block text-sm font-semibold text-slate-700">
              กรอกคำว่า <span className="rounded bg-slate-100 px-1.5 py-0.5 font-mono text-[#4A148C]">ปริ้น</span>
            </label>
            <input
              ref={input1Ref}
              type="text"
              ...
              className={`w-full rounded-xl border px-4 py-3 text-base font-medium outline-none transition focus:ring-2 ${
                word1 && word1.trim() !== "ปริ้น"
                  ...
                  : word1.trim() === "ปริ้น"
                    ...
                    : "border-slate-200 bg-white text-slate-900 focus:border-[#4A148C] focus:ring-[#4A148C]/10"
              }`}
            />
            {word1.trim() === "ปริ้น" ? (
          ...
          <div>
            <label className="mb-1.5 block text-sm font-semibold text-slate-700">
              กรอกคำว่า <span className="rounded bg-slate-100 px-1.5 py-0.5 font-mono text-[#4A148C]">ยืนยัน</span>
            </label>
            <input
              type="text"
              value={word2}
        ...
        <div className="flex gap-3 border-t border-slate-100 px-6 py-4">
          ...
          <button
            ...
            className={`flex flex-1 items-center justify-center gap-2 rounded-xl py-3 text-sm font-bold transition ${
              valid
                ? "bg-[#4A148C] text-white shadow-sm hover:bg-[#4A148C]"
  ...
  return (
    <>
      <button
        onClick={handleClick}
        disabled={isSaving}
        className="flex items-center gap-2 rounded-xl bg-[#4A148C] px-6 py-2.5 text-sm font-semibold text-white shadow hover:bg-[#4A148C] disabled:opacity-70"
      >
        {isSaving ? (
          <>
