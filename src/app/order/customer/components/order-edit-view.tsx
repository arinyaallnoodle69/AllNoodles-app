  ...
  return (
    <section className="space-y-4 p-4">
      <div className="rounded-[2rem] border border-[#EA80FC]/10 bg-[linear-gradient(180deg,#ffffff_0%,#F3E5F5_100%)] p-5 shadow-[0_10px_30px_-5px_rgba(0,0,0,0.04)]">
        <div className="text-xs font-semibold uppercase tracking-[0.18em] text-[#4A148C]/70">
          แก้ไขคำสั่งซื้อ
        </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          ...
          className="flex items-center justify-center gap-2 rounded-2xl border border-[#EA80FC]/15 bg-[#F3E5F5] px-4 py-3 text-sm font-bold text-[#4A148C] transition-all active:scale-[0.98]"
        >
          <X className="h-4 w-4" />
          ยกเลิก
        </button>
        <button
          ...
          disabled={isPending}
          className="flex items-center justify-center gap-2 rounded-2xl bg-[#4A148C] px-4 py-3 text-sm font-bold text-white shadow-[0_8px_16px_rgba(74,20,140,0.18)] transition-all active:scale-[0.98] disabled:opacity-60"
        >
          {isPending ? "กำลังบันทึก..." : "บันทึกการแก้ไข"}
        </button>
        <button
          onClick={onOpenAddProductSheet}
          className="col-span-2 flex items-center justify-center gap-2 rounded-2xl border border-[#EA80FC]/20 bg-white px-4 py-3 text-sm font-bold text-[#4A148C] shadow-[0_4px_12px_rgba(74,20,140,0.06)] transition-all active:scale-[0.98]"
        >
    ...
    >
      <div className="flex max-h-[85vh] flex-col rounded-t-[2rem] bg-white shadow-2xl">
        ...
        <div className="px-4 py-3">
          <div className="relative">
            ...
            <input
              ...
              className="w-full rounded-2xl border border-slate-200 bg-slate-50 py-2.5 pl-10 pr-4 text-sm outline-none transition-all focus:border-[#4A148C] focus:bg-white focus:ring-2 focus:ring-[#4A148C]/10"
            />
          </div>
        </div>
                  ...
                  <div className="flex flex-shrink-0 items-center gap-1">
                    {qty > 0 ? (
                      ...
                      <button
                        ...
                        className="flex h-9 items-center gap-1 rounded-full bg-[#4A148C] px-4 text-xs font-bold text-white transition-all active:scale-95"
                      >
        ...
        <div className="border-t border-slate-100 px-4 pb-6 pt-3">
          <button
            onClick={onClose}
            className="w-full rounded-2xl bg-[#4A148C] px-6 py-4 text-base font-bold text-white shadow-[0_12px_24px_rgba(74,20,140,0.22)] transition-all active:scale-[0.98]"
          >
