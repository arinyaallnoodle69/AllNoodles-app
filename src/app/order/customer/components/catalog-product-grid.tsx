  ...
  return (
    ...
    >
      <div className="relative aspect-square w-full shrink-0 overflow-hidden rounded-t-lg bg-white px-2 pb-2 pt-3 md:rounded-t-xl md:px-2.5 md:pb-2.5 md:pt-3.5">
        ...
        {qty > 0 && (
          <div className="absolute left-2 top-2 flex h-6 min-w-6 items-center justify-center rounded-full bg-[#082A63] px-1.5 text-[10px] font-bold text-white shadow-lg ring-2 ring-white md:h-[1.65rem] md:min-w-[1.65rem]">
            {qty}
          </div>
        )}
      ...
      <div className="flex min-w-0 flex-grow items-start justify-between gap-2 px-3 pb-3 pt-3 md:gap-2.5 md:px-3.5 md:pt-3.5">
        ...
        <div className="mt-0.5 flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#082A63] text-white shadow-md transition-transform active:scale-90 md:h-8 md:w-8">
