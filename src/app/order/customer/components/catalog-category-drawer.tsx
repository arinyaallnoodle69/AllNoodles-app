  ...
  return (
    <>
      <button
        ...
        aria-expanded={open}
        className="inline-flex h-8 shrink-0 items-center gap-1.5 rounded-lg bg-[#4A148C] px-3 text-[13px] font-bold text-white shadow-[0_7px_16px_rgba(74,20,140,0.2)] transition active:scale-[0.98]"
      >
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-slate-100 px-4 pb-3 pt-2.5">
          <div className="flex items-center gap-3">
            <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#F3E5F5] text-[#4A148C] ring-1 ring-[#EA80FC]/10">
  ...
  return (
    <button
      ...
      className={`flex min-h-11 items-center justify-between gap-1.5 rounded-lg border px-2.5 py-2 text-left text-[13px] font-bold transition active:scale-[0.98] ${
        active
          ? "border-[#EA80FC]/20 bg-[#F3E5F5] text-[#4A148C]"
