  ...
  return (
    <>
      ...
      {lastOrderMeta && (
        <>
          <button
            ...
            className="mb-4 w-full rounded-2xl border border-[#4A148C] bg-[#4A148C] px-4 py-3.5 text-left text-white shadow-[0_12px_24px_rgba(74,20,140,0.22)] transition-all hover:border-[#4A148C] hover:bg-[#4A148C]/95 active:scale-[0.98] disabled:opacity-60"
          >
          ...
          <button
            ...
            className="mb-3 w-full rounded-2xl border border-[#EA80FC]/15 bg-white px-4 py-3.5 text-left text-[#4A148C] shadow-sm transition-all hover:border-[#EA80FC]/25 hover:bg-[#F3E5F5] active:scale-[0.98]"
          >
      ...
      <button
        ...
        className="mb-8 flex w-full items-center justify-center gap-2 rounded-2xl border border-[#EA80FC]/15 bg-[#F3E5F5] px-6 py-4 text-base font-semibold text-[#4A148C] transition-all hover:bg-[#EA80FC]/20 active:scale-[0.98]"
      >
