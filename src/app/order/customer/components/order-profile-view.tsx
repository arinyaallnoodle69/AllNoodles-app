      ...
      <div className="flex flex-col items-center rounded-[2.5rem] border border-slate-50 bg-white p-8 shadow-[0_10px_30px_-5px_rgba(0,0,0,0.04)]">
        ...
        <div className="w-full space-y-4">
          <div className="flex items-center gap-3 text-slate-600">
            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#FAF7F2]">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-[#082A63]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
