        ...
        <div ref={shareMenuRef} className="relative flex gap-1">
          ...
          >
            <Star
              ...
              fill={favorites[selectedProduct.id] ? "#EA80FC" : "none"}
              stroke={favorites[selectedProduct.id] ? "#EA80FC" : "currentColor"}
              strokeWidth={2}
            />
          </button>
          <button
          ...
          >
            ...
            {totalItems > 0 && (
              <span className="absolute top-1 right-1 flex h-4.5 w-4.5 items-center justify-center rounded-full bg-[#EA80FC] text-[9px] font-black text-white shadow-sm ring-2 ring-white">
                {totalItems}
              </span>
            )}
          </button>
