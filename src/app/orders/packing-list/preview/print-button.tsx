          ...
          <div className="fixed inset-0 z-[500] flex flex-col bg-[#0a0c10] animate-in fade-in duration-300">
            <div className="sticky top-0 z-50 flex shrink-0 items-center justify-between border-b border-white/5 bg-[#12151c]/85 px-4 py-3 backdrop-blur-xl sm:px-8 sm:py-5">
              <div className="flex items-center gap-4">
                <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#4A148C] text-white shadow-[0_0_20px_rgba(4,53,106,0.4)] sm:h-12 sm:w-12">
                ...
                {!isCapturing && previewImages.length > 0 ? (
                  <>
                    <button
                      ...
                      className="hidden items-center gap-2.5 rounded-xl bg-[#4A148C] px-5 py-2.5 text-sm font-black text-white shadow-[0_8px_20px_rgba(82,109,130,0.3)] transition hover:bg-[#4A148C] active:scale-95 sm:flex"
                    >
                ...
                {isCapturing && previewImages.length === 0 ? (
                  <div className="flex flex-col items-center justify-center gap-8 py-20 text-slate-500">
                    <div className="relative">
                      ...
                      <Loader2 className="absolute inset-0 m-auto h-10 w-10 animate-spin text-[#4A148C]" strokeWidth={3} />
                    </div>
                ...
                {previewImages.map((image, index) => (
                  <div key={image.name} className="group relative flex w-full flex-col items-center">
                    <div className="mb-4 flex items-center gap-3 self-start sm:absolute sm:-left-20 sm:mb-0 sm:flex-col sm:self-auto">
                      <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#1a1f26] text-sm font-black text-white ring-1 ring-white/10 shadow-2xl transition group-hover:bg-[#4A148C] group-hover:ring-[#4A148C]/50">
                        {index + 1}
                      </span>
