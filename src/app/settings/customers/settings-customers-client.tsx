  ...
  return (
    <label className="relative block">
      ...
      <input
        ...
        className="w-full rounded-2xl border border-slate-200 bg-white py-3.5 pl-12 pr-4 text-base font-medium text-slate-900 shadow-sm outline-none transition placeholder:text-slate-400 focus:border-[#EA80FC]/50 focus:ring-4 focus:ring-[#EA80FC]/10"
      />
    </label>
  );
}
        ...
        <MobileSearchDrawer title="ค้นหาร้านค้า">
          <div className="space-y-4 p-4">
            ...
            <button
              type="button"
              onClick={() => setIsImportOpen(true)}
              className="w-full flex h-12 items-center justify-center gap-2 rounded-lg border border-[#EA80FC]/30 bg-white px-4 text-sm font-black text-[#4A148C] active:scale-95 transition-all"
            >
