        ...
        <div className="flex-1 space-y-4 p-4 print:hidden sm:p-6 md:space-y-6 md:p-8">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <div className="flex items-center gap-3">
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#F3E5F5] text-[#4A148C] shadow-sm">
                <FileText className="h-6 w-6" />
              </div>
              <div>
                <h1 className="text-2xl font-black text-[#4A148C] md:text-3xl">รายงานใบวางบิล</h1>
          ...
          <div className="hidden border border-slate-100 bg-white p-5 shadow-2xl sm:rounded-sm md:block">
            <form action="/reports/billing" method="get">
              <div className="flex flex-wrap items-end gap-3">
                ...
                <button
                  type="submit"
                  className="flex h-10 items-center gap-2 rounded-lg bg-[#4A148C] px-4 text-sm font-bold text-white shadow-sm transition hover:bg-[#4A148C] active:bg-[#7A422D]"
                >
              ...
              <div className={styles.printHeader}>
                <div className="mb-1 flex items-start justify-between gap-3">
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <div>
                      <p className="text-sm leading-tight font-black text-[#4A148C]">All Noodles</p>
                ...
                <p className="text-base font-black text-[#4A148C]">รายงานใบวางบิล</p>
