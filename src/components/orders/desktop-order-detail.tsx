        ...
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#4A148C]/15 text-[#4A148C]">
              ...
              <div>
                ...
                <p className="mt-0.5 font-mono text-base font-bold text-[#4A148C]">
          ...
          <div className="flex shrink-0 items-center gap-2">
            {canEdit ? (
              <button
                ...
                className="inline-flex items-center gap-2 rounded-lg bg-[#4A148C] px-5 py-2.5 text-sm font-bold text-white shadow-[0_8px_20px_rgba(4,53,106,0.12)] transition hover:bg-[#4A148C] active:scale-[0.98]"
              >
          ...
          {detail.items.map((item) => (
            <tr key={item.id} className="align-middle transition-colors hover:bg-slate-50/40">
              <td className="px-6 py-4 text-center">
                <span className="font-mono text-base font-bold text-[#4A148C]/80">{item.sku}</span>
              </td>
              ...
              <td className="px-6 py-4 text-center">
                <p className="font-mono text-lg font-bold tabular-nums text-[#4A148C]">
        ...
        <tfoot>
          <tr className="border-t border-slate-300 bg-slate-50">
            ...
            <td className="px-8 py-4 text-center">
              <p className="font-mono text-xl font-bold tabular-nums text-[#4A148C]">
