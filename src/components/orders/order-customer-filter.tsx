      ...
      <div className="border-b border-slate-100 p-3">
        <label className="relative block">
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2.5 pl-10 pr-10 text-sm font-medium text-slate-950 outline-none transition focus:border-[#082A63] focus:bg-white"
          />
          {query ? (
            <button
              type="button"
            ...
            return (
              ...
              >
                <input
                  ...
                  className="mt-0.5 h-4 w-4 rounded border-slate-300 text-[#082A63] focus:ring-[#082A63]"
                />
                ...
                {isChecked ? (
                  <Check className="mt-0.5 h-4 w-4 shrink-0 text-[#082A63]" strokeWidth={3} />
                ) : null}
              </label>
            );
          })
  ...
  return (
    <div ref={containerRef} className={`relative ${className}`}>
      ...
      <button
        ...
        className="inline-flex w-full items-center justify-between gap-3 rounded-lg border border-white/25 bg-white px-3 py-2.5 text-left text-sm font-medium text-slate-950 shadow-sm outline-none transition hover:border-[#082A63]/25 focus-visible:ring-2 focus-visible:ring-[#082A63]/15"
      >
