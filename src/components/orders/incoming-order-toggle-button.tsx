...
export function IncomingOrderToggleButton({
  ...
  return (
    <button
      ...
      className={[
        "inline-flex items-center justify-center border border-slate-200 bg-white text-slate-900 shadow-sm transition hover:border-[#082A63]/30 hover:bg-slate-50 hover:text-[#082A63] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#082A63]/20 disabled:opacity-85",
