      ...
      <div className="relative">
        ...
        <select
          ...
          className={[
            ...
            "focus:border-[#003366] focus:ring-1 focus:ring-[#003366]/10 disabled:opacity-60",
            selectedVehicleId
        ...
        {pending ? (
          <Loader2
            className="pointer-events-none absolute right-3 top-1/2 h-4 w-4 -translate-y-1/2 animate-spin text-[#003366]"
            strokeWidth={2}
          />
        ) : (
          <span
