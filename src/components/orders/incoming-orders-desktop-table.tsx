    ...
    <Fragment key={order.id}>
      {showDivider ? (
        <tr className="bg-[#F3E5F5]">
          <td colSpan={7} className="border-y border-[#EA80FC]/25 px-3 py-3 xl:px-6 xl:py-4">
            <div className="flex items-center gap-4">
              <div className="h-px flex-1 bg-[#EA80FC]/45" />
              <span className="rounded-2xl border border-[#EA80FC]/50 bg-white px-3 py-1 text-[11px] font-black uppercase tracking-[0.2em] text-[#4A148C] shadow-sm xl:px-5 xl:py-2 xl:text-xs">
        ...
        <td className="px-2 py-2 xl:px-3 xl:py-3">
          <div className="min-w-0">
            <div className="flex min-w-0 items-center gap-2">
              <Building2 className="h-4 w-4 shrink-0 text-[#4A148C]" strokeWidth={2.2} />
            ...
            <div className="mt-1 flex flex-wrap items-center gap-2 pl-6">
              <span className="shrink-0 rounded-full bg-[#EA80FC]/18 px-2 py-0.5 text-[10px] font-bold text-[#4A148C] ring-1 ring-[#EA80FC]/30">
                {order.channelLabel}
              </span>
              {order.warehouseName ? (
          ...
          {hasDisplayDelivery ? (
            <div className="flex min-w-0 flex-col items-start gap-1">
              {displayDeliveryNumbers.map((num) => (
                <span key={num} className="whitespace-nowrap font-mono text-sm font-bold text-[#EA80FC] xl:text-base">
                  {num}
                </span>
              ))}
            </div>
          ) : (
            <span className="text-sm font-medium text-[#4A148C] xl:text-base">-</span>
          )}
        </td>
        ...
        <td className="px-2 py-2 xl:px-3 xl:py-3">
          <div className="flex w-full items-center justify-center gap-2">
            ...
            <button
              ...
              className="inline-flex size-10 shrink-0 items-center justify-center rounded-full border border-[#EA80FC]/45 bg-white p-0 leading-none text-[#4A148C] shadow-sm transition hover:border-[#EA80FC] hover:bg-[#F3E5F5] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#EA80FC]/25 disabled:opacity-85"
            >
              {isLoading ? (
      ...
      <div className="lg:min-w-0 xl:min-w-[1150px]">
        ...
        <div className="relative">
          ...
          >
            ...
            <thead className="bg-[#4A148C] text-white">
              <tr className="border-b border-[#EA80FC]/45">
        ...
        >
          ...
          <div
            ...
            className="overflow-x-auto touch-pan-x [scrollbar-color:#4A148C_#cbd5e1] [scrollbar-width:auto] [&::-webkit-scrollbar]:h-3 [&::-webkit-scrollbar-track]:rounded-full [&::-webkit-scrollbar-track]:bg-slate-300 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-thumb]:bg-[#4A148C] [&::-webkit-scrollbar-thumb:hover]:bg-[#4A148C]"
          >
