...
export function PrintPackingListButton({
  ...
  return (
    <button
      ...
      onClick={handlePrint}
      disabled={loading}
      className="inline-flex items-center gap-1.5 whitespace-nowrap rounded-full border border-[#082A63]/20 bg-white px-3 py-1.5 text-[13px] font-bold text-[#082A63] shadow-sm transition hover:bg-[#082A63]/15 hover:shadow-md active:scale-[0.98] disabled:opacity-50 print:hidden md:gap-2 md:px-6 md:py-2.5 md:text-sm"
    >
