  ...
  return (
    <>
      ...
      >
        ...
        กดเพื่อตั้งราคา {items.length} รายการ
      </button>
      ...
      {open ? (
        <>
          ...
          <div className="fixed inset-x-0 bottom-0 z-50 flex justify-center p-0 pt-[max(0.75rem,env(safe-area-inset-top))] sm:inset-0 sm:items-center sm:p-4">
            <div className="mt-auto flex max-h-[calc(100dvh-env(safe-area-inset-top)-0.75rem)] w-full flex-col overflow-hidden rounded-t-[1.75rem] border border-slate-200 bg-white shadow-[0_28px_80px_rgba(15,23,42,0.25)] sm:mt-0 sm:max-h-[min(78dvh,46rem)] sm:max-w-lg sm:rounded-[1.75rem]">
                        ...
                        >
                          <div className="flex items-start justify-between gap-3">
                            <div className="flex min-w-0 flex-1 items-start gap-3">
                              <div className="relative mt-0.5 h-14 w-14 shrink-0 overflow-hidden rounded-2xl border border-slate-200 bg-white">
                                {item.imageUrl ? (
                                  <Image
                                    src={item.imageUrl}
                              ...
                              <div className="min-w-0 flex-1">
                                <div className="overflow-x-auto whitespace-nowrap [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
                                  <p
                                    className={`inline-block text-base font-bold leading-snug ${
                            ...
                            <>
                              <div className="relative mt-4">
                                ...
                                <input
                                  ...
                                  className={`w-full rounded-xl border bg-white py-3.5 pl-9 pr-4 text-base font-medium text-slate-900 outline-none transition focus:border-[#4A148C] focus:ring-2 focus:ring-[#4A148C]/15 ${
              ...
              <div className="space-y-3 border-t border-slate-100 px-6 py-4">
                ...
                {!allSaved ? (
                  <button
                    ...
                    className="w-full rounded-2xl bg-[#4A148C] py-3.5 text-base font-semibold text-white shadow-sm transition hover:bg-[#4A148C] active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-40"
                  >
                    {isPending
                      ? "กำลังบันทึก..."
                      : `บันทึกราคาทั้งหมด ${pendingItems.length} รายการ`}
                  </button>
                ) : null}
