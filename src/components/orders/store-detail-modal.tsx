            ...
            <div className="flex items-center justify-between">
              <div className="min-w-0 flex-1 pr-4">
                <div className="flex items-center gap-2">
                  <span className="shrink-0 rounded bg-[#4A148C]/15 px-1.5 py-0.5 font-mono text-[10px] font-bold uppercase tracking-wider text-[#4A148C]">
                    {detail.customerCode}
                  </span>
            ...
            <div key={detail.customerId} className="space-y-4 p-4 pb-[env(safe-area-inset-bottom,2rem)]">
              ...
              {detail.orderRounds.length > 0 ? (
                <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                  ...
                  >
                    <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#F3E5F5] text-[#4A148C]">
                  ...
                  >
                    <div className="divide-y divide-slate-50 bg-slate-50/30">
                      {detail.orderRounds.map((round) => (
                        ...
                        >
                          <div className="h-1.5 w-1.5 shrink-0 rounded-full bg-[#4A148C]" />
                          <div className="min-w-0 flex-1">
                            <p className="font-mono text-xs font-bold text-[#4A148C]">
                              {round.orderNumber}
                            </p>
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between border-t border-slate-100 bg-slate-50/50 px-4 py-3">
                      <div>
                        ...
                        <p className="text-[15px] font-black text-[#4A148C]">
              ...
              <div className="sticky bottom-0 mt-6 flex items-center justify-between rounded-2xl border border-[#4A148C]/10 bg-[#4A148C] px-6 py-4 shadow-[0_-8px_30px_rgba(0,0,0,0.1)]">
                ...
                <table className="min-w-[860px] border-collapse text-left text-sm">
                        ...
                        <td className="border-r border-slate-200 px-3 py-3 text-center">
                          {item.shortQuantity > 0 ? (
                            <div className="flex flex-col items-center gap-1">
                              ...
                              <Link
                                href={`/stock?receive=1&product=${item.productId}`}
                                className="inline-flex items-center gap-1 rounded-md border border-[#4A148C]/25 bg-[#4A148C]/15 px-2 py-1 text-[11px] font-semibold text-[#4A148C] transition active:bg-[#4A148C]/20"
                              >
                  ...
                  <tfoot>
                    <tr className="bg-slate-50">
                      ...
                      <td className="border-t border-slate-200 px-3 py-3 text-center text-base font-bold tabular-nums text-[#4A148C]">
                        {formatTHB(detail.totalAmount)}
                      </td>
                    </tr>
                  </tfoot>
