...
export function PushNotificationBanner() {
  ...
  if (status === "install") {
    return (
      <div className="mx-4 mt-3 rounded-2xl border border-[#4A148C]/15 bg-white px-4 py-3 text-sm text-slate-700 shadow-sm md:mx-6">
        <div className="flex items-start gap-3">
          <Download className="mt-0.5 h-5 w-5 shrink-0 text-[#4A148C]" strokeWidth={2.2} />
  ...
  return (
    <div className="mx-4 mt-3 rounded-2xl border border-[#4A148C]/15 bg-white px-4 py-3 text-sm text-slate-700 shadow-sm md:mx-6">
      <div className="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
        <div className="flex items-start gap-3">
          <Bell className="mt-0.5 h-5 w-5 shrink-0 text-[#4A148C]" strokeWidth={2.2} />
          <div className="space-y-1">
        ...
        {status === "ready" ? (
          <button
            ...
            disabled={isBusy}
            className="inline-flex items-center justify-center gap-2 rounded-xl bg-[#4A148C] px-4 py-2.5 text-sm font-semibold text-white transition hover:bg-[#4A148C] disabled:opacity-50"
          >
