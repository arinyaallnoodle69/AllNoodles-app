    ...
    <>
      ...
      {showSuccess ? (
        <>
          ...
          <div className="fixed left-1/2 top-1/2 z-[80] w-[calc(100%-2rem)] max-w-sm -translate-x-1/2 -translate-y-1/2 overflow-hidden rounded-2xl bg-white shadow-[0_20px_56px_rgba(0,51,102,0.28)] ring-1 ring-[#003366]/15">
            <div className="flex items-center gap-3 px-4 py-3.5">
              <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#003366]/10">
                <CheckCircle2 className="h-5 w-5 text-[#003366]" strokeWidth={2} />
              </div>
