        ...
        <div className="flex items-start justify-between gap-4 border-b border-[#e8e8e8] px-6 py-5">
          <div>
            ...
            <div className="mt-1.5 flex items-center gap-2.5 text-[#1a1a1a]">
              {isEditMode ? (
                <PencilLine className="h-6 w-6 text-[#082A63]" strokeWidth={2} />
              ) : (
                <CirclePlus className="h-6 w-6 text-[#082A63]" strokeWidth={2} />
              )}
        ...
        >
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className={`pl-10 h-11 rounded-md bg-white border-[#e8e8e8] focus-visible:ring-2 focus-visible:ring-[#082A63]/20 focus-visible:border-[#082A63] text-sm text-[#1a1a1a] placeholder:text-[#c2c2c2] ${
          ...
          <div className="flex shrink-0 items-center justify-end gap-3 border-t border-[#e8e8e8] bg-white px-5 py-4 pb-[max(1rem,env(safe-area-inset-bottom))] sm:px-6">
            ...
            <Button
              ...
              size="lg"
              disabled={isPending}
              className="h-11 inline-flex items-center gap-2 rounded-md bg-[#082A63] hover:bg-[#103B82] text-white px-6 font-semibold text-sm tracking-[0.7px] uppercase shadow-[0_2px_8px_rgba(8,42,99,0.18)] transition disabled:cursor-not-allowed disabled:opacity-60"
            >
