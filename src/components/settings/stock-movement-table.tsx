                  ...
                  <div key={m.id} className="bg-white rounded-lg border-2 border-slate-300 p-3 shadow-sm active:bg-slate-50 transition-colors">
                    ...
                    <div className="flex items-center justify-between pt-2 border-t-2 border-slate-100">
                      <div className="min-w-0 flex items-center gap-2">
                        ...
                        <span className="text-[12px] font-black text-[#4A148C] underline decoration-2 decoration-[#F3E5F5] truncate">
              ...
              {filteredMovements.map((m) => (
                <tr key={m.id} className="hover:bg-slate-50 transition-colors group">
                  ...
                  <td className="py-3 px-4 border-l border-slate-100">
                    <div className="font-black text-[#0f172a] text-[15px] group-hover:text-[#4A148C] transition-colors leading-tight">
                    ...
                    <div className="mt-1 inline-flex items-center gap-1 rounded-full bg-[#F3E5F5] px-2 py-0.5 text-[10px] font-black text-[#4A148C]">
                      <Warehouse className="h-3 w-3" strokeWidth={2.4} />
                      {m.warehouseId ? (warehouseNameMap.get(m.warehouseId) ?? "คลังสินค้า") : "ยังไม่ระบุคลัง"}
                    </div>
                  </td>
                  ...
                  <td className="py-3 px-4 border-l border-slate-100">
                    <span className="text-[#4A148C] hover:text-[#4A148C] font-black cursor-default underline decoration-2 decoration-[#F3E5F5] transition-colors whitespace-normal break-all line-clamp-2">
                      {m.referenceNumber || m.notes || "-"}
                    </span>
                  </td>
