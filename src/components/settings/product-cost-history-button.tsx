  ...
  return (
    <div className="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
      <div className="mb-3 flex items-start justify-between gap-2">
        <div>
          <span className="inline-flex items-center rounded-full bg-[#082A63]/20 px-3 py-1 text-sm font-bold text-[#082A63]">
            {row.unit_label}
          </span>
        </div>
            ...
            <div className="flex shrink-0 items-center justify-between border-b border-slate-200 bg-white px-5 py-4 sm:rounded-t-2xl">
              <div>
                <div className="flex items-center gap-2">
                  <History className="h-5 w-5 text-[#082A63]" strokeWidth={2} />
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3">
              {isPending && (
                <div className="flex items-center justify-center py-12">
                  <div className="h-8 w-8 animate-spin rounded-full border-4 border-slate-200 border-t-[#082A63]" />
                </div>
              )}
