      ...
      <div className={`relative flex h-full w-full max-w-lg flex-col overflow-hidden bg-[#F3E5F5] shadow-2xl rounded-none sm:rounded-[2.8rem] border border-white/40 ${
        ...
        <div className="shrink-0 bg-white/80 backdrop-blur-md px-6 py-5 border-b border-slate-200/60 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-xl font-black text-[#4A148C]">ปรับปรุงยอดสต็อก</h2>
          </div>
        </div>
            ...
            <div className="p-6">
              <div className="relative mb-6">
                ...
                <input
                  ...
                  className="w-full h-14 pl-12 pr-4 bg-white border-2 border-slate-100 rounded-2xl outline-none focus:border-[#4A148C]/20 transition-all text-lg font-bold"
                  value={searchQuery}
                ...
                {filteredProducts.map((p) => (
                  ...
                  >
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mt-1 text-sm font-bold text-[#4A148C]">คงเหลือ: {p.onHandQuantity} {p.unit}</p>
                    </div>
                  </button>
                ))}
              </div>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="min-w-0 flex-1">
                    <button 
                      ...
                      className="text-[10px] font-black text-[#4A148C] uppercase tracking-widest flex items-center gap-1 mb-1"
                    >
              ...
              <div className="p-6 space-y-8">
                ...
                <div className="space-y-4 text-center">
                  ...
                  <div className="flex items-center justify-center gap-6">
                    ...
                    <button
                      ...
                      className="h-16 w-16 flex items-center justify-center rounded-3xl bg-[#4A148C] text-white active:scale-90 transition-all shadow-lg shadow-[#4A148C]/20"
                    >
                ...
                <div className="bg-[#F3E5F5]/50 rounded-[2rem] p-6 border border-[#EA80FC]/50 space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-bold text-[#4A148C]/60">คงเหลือเดิม</span>
                  ...
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-bold text-[#4A148C]/60">ยอดปรับปรุง</span>
                    <span className="text-lg font-black text-[#4A148C]">
                ...
                <div className="space-y-3">
                  ...
                  <textarea
                    ...
                    className="w-full h-32 p-5 rounded-3xl bg-white border-2 border-slate-100 outline-none focus:border-[#4A148C]/20 transition-all text-lg font-medium resize-none"
                  />
                </div>
              </div>
            </div>
