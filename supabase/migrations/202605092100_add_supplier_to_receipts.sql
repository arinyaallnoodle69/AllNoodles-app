-- Migration: Add supplier_id to inventory_receipts and update create_inventory_receipt function.

alter table public.inventory_receipts
add column if not exists supplier_id uuid references public.suppliers(id) on delete set null;

-- Add index for performance
create index if not exists inventory_receipts_supplier_id_idx on public.inventory_receipts(supplier_id);

-- Update create_inventory_receipt function to handle p_supplier_id
