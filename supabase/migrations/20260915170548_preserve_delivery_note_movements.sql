-- Preserve the immutable stock ledger when an existing delivery note is rebuilt.
...
drop function if exists public.create_store_delivery_note(
  uuid, uuid[], uuid, uuid, date, text, uuid, jsonb, uuid, numeric, numeric
);
drop function if exists public.create_store_delivery_note(
  uuid, uuid[], uuid, uuid, date, text, uuid, jsonb, uuid, numeric, numeric, jsonb
);
